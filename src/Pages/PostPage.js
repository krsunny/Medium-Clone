...
export default function PostPage() {
  ...
  return (
    <>
      {loading?<><Loader/></>:<Card className={classes.card}>
          ...
          <div>
            ...
            <span className={classes.body}>
              ...
              {countWords(postsbyid.content) > "500"
                ? Math.floor(countWords(postsbyid.content) / wpm) + " " + "min read"
                : "2 min read"}
            </span>
          </div>
        </div>
            ...
            <div style={{ float: "right" }}>
              <Dropdown>
                ...
                <Dropdown.Menu className={classes.dropDownMenu}>
                  <Dropdown.Item onClick={clearClap}>Remove clap</Dropdown.Item>
                </Dropdown.Menu>
              </Dropdown>
            </div>
          </>
